...
def statistics_snapshot(result):
    ...
    return {
        ...
        "mapPresence": [{
            ...
            "expansions": p["mapPresence"]["expansions"]["count"],
            "enemyBaseFoundAtMs": p["mapPresence"]["enemyBaseFound"]["atMs"],
            "enemyBaseFoundPlayerId": p["mapPresence"]["enemyBaseFound"]["enemyPlayerId"],
