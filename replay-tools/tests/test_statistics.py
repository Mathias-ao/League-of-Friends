...
def statistics_snapshot(result):
    ...
    return {
        ...
        "mapPresence": [{
            ...
            "deepestForwardAdvantageTiles": p["mapPresence"]["forwardBuildings"]["deepest"]["maxEnemyDistanceAdvantageTiles"],
            "buildingSpreadTiles": p["mapPresence"]["buildingSpread"]["maxPairwiseDistanceTiles"],
