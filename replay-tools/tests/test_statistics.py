...
def statistics_snapshot(result):
    ...
    return {
        ...
        "economy": [{
            "playerId": p["playerId"],
            "modelVersion": p["economy"]["modelVersion"],
            "villagersTrained": p["economy"]["villagersTrained"]["count"],
            "villagersBy20Minutes": p["economy"]["villagersBy20Minutes"]["count"],
            "tcIdleDarkAgeMs": p["economy"]["tcIdleTimeDarkAge"]["valueMs"],
            "townCenters": p["economy"]["townCenters"]["count"],
            "firstExtraTcAtMs": p["economy"]["firstExtraTownCenterTime"]["atMs"],
            "thirdTcAtMs": p["economy"]["thirdTownCenterTime"]["atMs"],
            "ecoTechs": p["economy"]["economicTechsResearched"]["count"],
        ...
        "military": [{
            "playerId": p["playerId"],
            "modelVersion": p["military"]["modelVersion"],
            "militaryUnitsTrained": p["military"]["militaryUnitsTrained"]["count"],
            "militarySpend": p["military"]["militarySpend"]["resources"],
            "infantry": p["military"]["composition"]["infantry"],
            "archers": p["military"]["composition"]["archers"],
            "cavalry": p["military"]["composition"]["cavalry"],
            "siege": p["military"]["composition"]["siege"],
            "monks": p["military"]["composition"]["monks"],
            "warships": p["military"]["composition"]["warships"],
            "firstMilitaryProductionAtMs": p["military"]["firstMilitaryProduction"]["atMs"],
            "firstSiegeAtMs": p["military"]["firstSiege"]["atMs"],
            "militaryBuildings": p["military"]["militaryBuildings"]["count"],
            "armyCommitment10m": p["military"]["armyCommitmentCheckpoints"]["at10Minutes"]["grossPositiveQueueResources"],
            "armyCommitment15m": p["military"]["armyCommitmentCheckpoints"]["at15Minutes"]["grossPositiveQueueResources"],
            "armyCommitment20m": p["military"]["armyCommitmentCheckpoints"]["at20Minutes"]["grossPositiveQueueResources"],
            "trashUnits": p["military"]["trashUnits"]["count"],
            "trashSharePercent": p["military"]["trashArmyShare"]["percent"],
            "productionBuildingsUsed": p["military"]["productionBuildingsUsed"]["count"],
            "castles": p["military"]["castles"]["count"],
            "blacksmithUpgrades": p["military"]["blacksmithUpgrades"]["count"],
        ...
        "mapPresence": [{
            "playerId": p["playerId"],
            "modelVersion": p["mapPresence"]["modelVersion"],
            "commandCoveragePercent": p["mapPresence"]["commandMapCoverage"]["percent"],
            "scoutCoverage5mPercent": p["mapPresence"]["scoutCoverageAt5Minutes"]["percent"],
            "scoutOrders5m": p["mapPresence"]["scoutCoverageAt5Minutes"]["orderCount"],
            "forwardBuildings": p["mapPresence"]["forwardBuildings"]["count"],
            "deepestForwardProgressPercent": p["mapPresence"]["forwardBuildings"]["deepest"]["maxEnemyProgressPercent"],
            "buildingPlacementSpanTiles": p["mapPresence"]["buildingPlacementRange"]["maximumPlacementSpanTiles"],
            "enemySidePresencePercent": p["mapPresence"]["enemySideCommandPresence"]["percent"],
            "wallTilesTotal": p["mapPresence"]["wallTiles"]["totalWallTiles"],
            "towers": p["mapPresence"]["towers"]["count"],
            "forwardTowers": p["mapPresence"]["towers"]["forwardCount"],
            "campAverageDistanceTiles": p["mapPresence"]["campDistanceFromHomeTownCenter"]["averageTiles"],
            "expansionTownCenters": p["mapPresence"]["expansionTownCenters"]["count"],
            "enemyBaseContactAtMs": p["mapPresence"]["enemyBaseContact"]["atMs"],
            "enemyBaseContactPlayerId": p["mapPresence"]["enemyBaseContact"]["enemyPlayerId"],
            "goldControlSharePercent": p["mapPresence"]["goldControl"]["controlSharePercent"],
            "firstRelicTouchAtMs": p["mapPresence"]["firstRelicTouch"]["atMs"],
            "uniqueRelicsTouched": p["mapPresence"]["relicControl"]["uniqueRelicsTouched"],
            "inferredRelicsHeldAtEnd": p["mapPresence"]["relicControl"]["inferredRelicsHeldAtEnd"],
        } for p in result["participants"]],
