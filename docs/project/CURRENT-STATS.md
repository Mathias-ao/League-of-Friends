...
- Great Battles fought: exceptional multiplayer-only promotion requiring at least 4 contributing players, 60 seconds, 80 potential-combat distinct selected instances after excluding directly known non-military selections and 10 strong Skirmish commands. A 1v1 cannot be a Great Battle.
